...
export const ModelSelectorTrigger = ({
  ...
  // The event is passed on rather than dropped: `onPress` is typed as taking a
  // `GestureResponderEvent`, and the CLI called it with none.
...
export const ModelSelectorContent = ({
  ...
  // Narrowed off the spread props, whose `children` is Reanimated's
  // `ReactNode | SharedValue<ReactNode>` — a modal body is never a shared value.
  children,
  className,
