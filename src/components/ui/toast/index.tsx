...
// `styled` here is the local shim, not NativeWind's. Over a Reanimated
// animated component the upstream signature overflows the checker outright
// (TS2589/TS2590) — see ../styled-shim.ts.
